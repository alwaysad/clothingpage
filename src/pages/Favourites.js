...
const Favourites=()=>{
    ...
    return <div>
        {!Items.length&&<div className="flex justify-center content-center"><p class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">There is no item in favourites</p></div>}
